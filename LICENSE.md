**ABSOLVE-seq is distributed under a dual-license model:**

**1. Academic Use**

ABSOLVE-seq is freely available for academic research under the GNU Affero
    General Public License v3.0 (AGPL-3.0)
    (https://www.gnu.org/licenses/agpl-3.0.en.html)

**2. Commercial Use**

For-profit institutions or users intending to use ABSOLVE-seq for commercial
